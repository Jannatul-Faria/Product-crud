...
use Laravel\Sanctum\Sanctum;
 ...
 Route::view('/dashboard', 'backend.Pages.dashboard.dashboard')->name('dashboard');
// Web Api Routes:
...
Route::post('/sendOtp', [UserController::class, 'sentOtp']);
Route::post('/varifyOtp', [UserController::class, 'varifyOtp']);
Route::post('/reset', [UserController::class, 'reset'])->middleware('auth:sanctum');
...
// Page Routes:
Route::view('/userLogin', 'backend.Pages.auth.login')->name('login');
Route::view('/userRegistation', 'backend.Pages.auth.register');
...
//Route::view('/userProfile', 'backend.Pages.dashboard.profile');
